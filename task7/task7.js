const link =
  "http://api.weatherstack.com/current?access_key=c85b2b9d5a3354856598958df66a0e02";
...
const markup = () => {
  const { country, city, description, observationTime, temperature, isDay, properties, localtime } = store;
